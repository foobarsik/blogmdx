...
<section className="about-hero">
  ...
  <div className="about-hero-content">
    <p className="about-hero-kicker">ABOUT ME</p>
    <h2 className="about-hero-title">Hi, I&apos;m Olga</h2>
    <p className="about-hero-tagline">Not a rockstar — I just keep chaos shippable.</p>
    <p className="about-hero-role">Frontend / Mobile / Product-minded engineer</p>
  </div>
</section>
